...
// Use bracelet_049.jpg to bracelet_054.jpg for Silver Bracelets (6 products)
const silverBraceletImages = [
  '/images/bracelet_049.jpg',
  '/images/bracelet_050.jpg',
  '/images/bracelet_051.jpg',
  '/images/bracelet_052.jpg',
  '/images/bracelet_053.jpg',
  '/images/bracelet_054.jpg',
];

const products = silverBraceletImages.map((img, idx) => ({
  id: idx + 1,
  name: `Silver Bracelet ${idx + 1}`,
  price: 8000 + idx * 700,
  image: img,
  description: "Modern silver bracelet with premium finish.",
}));
...
export default function SilverBracelets() {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-yellow-900">Silver Bracelets</h1>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {products.map((product) => (
          <div key={product.id} className="group bg-white rounded-xl shadow-md flex flex-col items-center hover:shadow-xl transition-shadow p-4 relative overflow-hidden">
            ...
            <div className="text-sm text-gray-500 mb-2 text-center">Silver Bracelet</div>
