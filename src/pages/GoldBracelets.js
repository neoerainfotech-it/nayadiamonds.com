...
// Use bracelet_039.jpg to bracelet_042.jpg for Gold Bracelets (4 products)
const goldBraceletImages = [
  '/images/bracelet_039.jpg',
  '/images/bracelet_040.jpg',
  '/images/bracelet_041.jpg',
  '/images/bracelet_042.jpg',
];

const products = goldBraceletImages.map((img, idx) => ({
  id: idx + 1,
  name: `Gold Bracelet ${idx + 1}`,
  price: 12000 + idx * 900,
  image: img,
  description: "Elegant gold bracelet with premium finish.",
}));
...
export default function GoldBracelets() {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-yellow-900">Gold Bracelets</h1>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {products.map((product) => (
          <div key={product.id} className="group bg-white rounded-xl shadow-md flex flex-col items-center hover:shadow-xl transition-shadow p-4 relative overflow-hidden">
            ...
            <div className="text-sm text-gray-500 mb-2 text-center">Gold Bracelet</div>
