  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <p className="mb-8 text-lg text-gray-700 max-w-2xl">
        Our most popular pieces, loved by customers for their timeless beauty and
        quality. Shop our best sellers and find your next favorite.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {bestSellers.length === 0 ? (
          ...
          bestSellers.map((product) => (
            <div
              key={product.id}
              className="group bg-white rounded-xl shadow-md p-4 flex flex-col items-center hover:shadow-xl transition-shadow relative"
            >
              ...
              <img
                ...
                alt={product.name}
                className="w-40 h-40 object-cover rounded-lg mb-4 border border-gray-100"
              />
              <h2 className="text-lg font-semibold mb-1 text-yellow-900 text-center">
              ...
              <div className="text-yellow-700 font-bold mb-2 text-center">
                ₹{product.price}
              </div>
      ...
      {quickView && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full relative">
            ...
            <img src={quickView.images[0]} alt={quickView.name} className="w-48 h-48 object-cover rounded-lg mx-auto mb-4" />
